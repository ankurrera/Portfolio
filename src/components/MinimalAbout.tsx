  ...
  return (
    <section id="about" className="py-section bg-muted/20">
      <div className="max-w-content mx-auto px-8">
        {/* Header */}
        {loadingAbout ? (
          <div className="space-y-4 py-8 max-w-xs">
            <MHSkeleton variant="text" className="h-4 w-12" />
            <MHSkeleton variant="text" className="h-10 w-2/3" />
          </div>
        ) : aboutData && (
          <>
            <motion.div
                  ...
                  {[1, 2].map((i) => (
                    <div key={i} className="flex justify-between items-start py-3 border-b border-border/50">
                      <div className="space-y-2 flex-1">
                        <MHSkeleton variant="text" className="h-4 w-1/3" />
                        <MHSkeleton variant="text" className="h-3 w-1/4" />
                      </div>
                      <MHSkeleton variant="text" className="h-3 w-24" />
                    </div>
                  ))}
                </div>
