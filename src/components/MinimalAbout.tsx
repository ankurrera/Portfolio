...
const MinimalAbout = () => {
  ...
  return <section id="about" className="py-section bg-muted/20">
      <div className="max-w-content mx-auto px-8">
        ...
        duration: 0.6
          ...
          <h2 className="text-section font-heading font-light text-foreground mb-8">Who Am I?</h2>
        </motion.div>
          ...
          delay: 0.2
                  ...
                  <Card className="minimal-card bg-card/50 hover:bg-card transition-all duration-300">
                    <CardContent className="p-6 space-y-4">
                      ...
                      <div className="space-y-2">
                        {skillGroup.items.map(item => <div key={item} className="text-xs font-mono text-muted-foreground py-1">
                            {item}
                          </div>)}
                      </div>
                    </CardContent>
            ...
            <div className="space-y-6 pt-8">
              ...
              <div className="space-y-4">
                ...
                company: 'Freelance',
                year: '2019 - Current'
              }].map((exp, index) => <motion.div key={index} initial={{
                opacity: 0,
                x: 20
              }} whileInView={{
                opacity: 1,
